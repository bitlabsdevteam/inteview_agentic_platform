---
name: walkthrough
description: Use when the user asks for sprint review docs, implementation walkthroughs, release summaries, or "what was built". This skill reads sprint artifacts and code changes, then generates a complete self-contained WALKTHROUGH.md report.
---
