---
name: prd
description: Use when the user asks to brainstorm requirements, define a sprint, create a roadmap, or generate PRD and task artifacts. Trigger for requests like "create a PRD", "plan sprint v1", "define tasks", or "what should we build next".
---

# `/prd` Skill Definition

Custom Claude Code skill for brainstorming requirements and creating sprint PRDs with atomic tasks.
